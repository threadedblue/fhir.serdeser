...
//		module.addDeserializer(EObject.class, new EMFDeserializer());
		...
		module.addDeserializer(org.hl7.fhir.ExplanationOfBenefit.class, new ExplanationOfBenefitDeserialazer());
...
//			return loadRDF(reader, RDFFormat.NTRIPLES);
	...
	public static EObject loadJSON(JsonNode jn) {
		...
		try {
			...
			log.debug("resourceType being processed=" + s);
